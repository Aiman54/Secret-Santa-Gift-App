...
<head>
  ...
  <style>
  /* CSS for the transparent header */
  body {
    margin: 0;
    padding: 0;
  ...
  <header class="header">
    <div class="header-content">
      ...
      <div class="header-buttons">
        ...
        <button class="header-button">Browse Gift</button>
        <button class="header-button">Friend List</button>
...
<body>
  <h1></h1>
  <form action="http://localhost:8501" target="_blank">
    <input type="submit" value="Product Recommender" class="redirect-button">
  </form>
</body>
</html>
