<?php
	...
	if(empty($info['errors']) && $row)
	{
		...
		db_query("update users set firstname = :firstname, lastname = :lastname, gender = :gender, date = :date, email = :email, wishlist = :wishlist $image_query $password_query where id = :id limit 1",$arr);
