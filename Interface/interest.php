	...
	<?php if(!empty($row)):?>
		...
		<div class="row col-lg-8 border rounded mx-auto mt-5 p-2 shadow-lg">
			...
			<div class="col-md-8">
				...
				<div class="h2">Edit Interest</div>

				<form method="post" onsubmit="myaction.collect_data(event, 'update_interests')">
					<table class="table table-striped">
						<tr><th colspan="2">User Interest:</th></tr>
						<tr>
						...
						<input type="hidden" name="data_type" value="update_interests">
                        <tr>
							<th><i class="bi bi-person-square"></i> Interest 1</th>
							<td>
								<select class="form-select" name="interest1">
								...
								<option value="Dress Up & Pretend Play">Dress Up & Pretend Play</option>
								<option value="Games & Accessories">Games & Accessories</option>
								<option value="Hobbies">Hobbies</option>
								<option value="Kids' Electronics">Kids' Electronics</option>
								<option value="Kids' Furniture, Decor & Storage">Kids' Furniture, Decor & Storage</option>
								<option value="Learning & Education">Learning & Education</option>
								<option value="Novelty & Gag Toys">Novelty & Gag Toys</option>
								...
								<option value="Toys figure & playsets">Toys figure & playsets</option>
								</select>
								<div><small class="js-error js-error-interest1 text-danger"></small></div>
							</td>
						</tr>
						<tr>
							<th><i class="bi bi-person-square"></i> Interest 2</th>
							<td>
								<select class="form-select" name="interest2">
								<option value="">-- Select Interest --</option>
								<option value="Arts & Crafts">Arts & Crafts</option>
								<option value="Collectible Toys">Collectible Toys</option>
								<option value="Dolls & Accessories">Dolls & Accessories</option>
								...
								<div><small class="js-error js-error-interest2 text-danger"></small></div>
							</td>
						</tr>
						<tr>
							<th><i class="bi bi-person-square"></i> Interest 3</th>
							<td>
								<select class="form-select" name="interest3">
								<option value="">-- Select Interest --</option>
								<option value="Arts & Crafts">Arts & Crafts</option>
								<option value="Collectible Toys">Collectible Toys</option>
								<option value="Dolls & Accessories">Dolls & Accessories</option>
								...
								<div><small class="js-error js-error-interest3 text-danger"></small></div>
							</td>
						</tr>
                        <tr>
...
<script>
    ...
    collect_data: function (e, data_type) {
        ...
        // Include the following lines to append the "interest2" and "interest3" data to the form
        myform.append('interest1', document.querySelector('[name="interest1"]').value);
        myform.append('interest2', document.querySelector('[name="interest2"]').value);
        myform.append('interest3', document.querySelector('[name="interest3"]').value);
